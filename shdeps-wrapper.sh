...
#
# This file is the sourceable Bash API that release archives will expose once
# the Rust binary owns behavior. Keep it intentionally small: every substantial
# operation should live in Rust and be reached through the public CLI or hidden
# `shdeps __api` bridge. That keeps the sourceable contract available for
# dotfiles/hooks without letting a second Bash implementation drift from Rust.
